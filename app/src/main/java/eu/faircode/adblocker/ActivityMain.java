...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String ACTION_RULES_CHANGED = "eu.faircode.adblocker.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "eu.faircode.adblocker.ACTION_QUEUE_CHANGED";
