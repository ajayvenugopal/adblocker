...
* [On Google Play](https://play.google.com/store/apps/details?id=eu.faircode.adblocker) (stable)
* [On Google Play](https://play.google.com/apps/testing/eu.faircode.adblocker) (beta)
* [XDA Labs App](http://forum.xda-developers.com/android/apps-games/labs-t3241866) ([web page](https://labs.xda-developers.com/store/app/eu.faircode.adblocker))
...
* You can translate online [here](https://crowdin.com/project/adblocker/)
* If your language is not listed, please send a message to marcel(plus)adblocker(at)faircode(dot)eu
* You can see the status of all translations [here](https://crowdin.com/project/adblocker).
